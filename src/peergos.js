...
var AppConfiguration = require('./components/app-sandbox/configuration');
var AppInstallation = require('./components/app-sandbox/installation');
var AppManagement = require('./components/app-sandbox/management');
...
Vue.component('app-installation', Vue.extend(Downloader).extend(AppConfiguration).extend(AppInstallation));
Vue.component('app-management', Vue.extend(AppConfiguration).extend(AppManagement));
Vue.component('appgrid', Vue.extend(AppConfiguration).extend(AppGrid));
...
Vue.component('sandbox', Vue.extend(Sandbox));
