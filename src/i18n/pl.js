module.exports = {
    ...
    "DRIVE.PASTE":"Wklej",
    "DRIVE.WITH":"Z",
    "DRIVE.SELECT":"Zaznacz",
    "DRIVE.SELECTED":"wybrane",
    "DRIVE.SORT":"Sortuj według",
    "DRIVE.SORT.ASC":"Rosnąco",
    "DRIVE.SORT.DESC":"Malejąco",
    "DRIVE.NAME":"Nazwa",
    "DRIVE.SIZE":"Rozmiar",
    "DRIVE.TYPE":"Typ",
    ...
    "DRIVE.SHARED.PEOPLE":"Udostępnione osobom",
    "DRIVE.SHARED.LINK":"Udostępnione tajnym linkiem",
    ...
    "LINK.UNAVAILABLE":"Nie można otworzyć tego linku",
    "LINK.UNAVAILABLE.USED_UP":"Został już otwarty tyle razy, ile pozwolił właściciel. Poproś go o nowy link.",
    ...
    "DRIVE.SHARE.LIMIT": "Limit miejsca",
    "DRIVE.SHARE.LIMIT.NONE": "Brak limitu",
    "DRIVE.SHARE.LIMIT.SET": "Ustaw limit",
    "DRIVE.SHARE.LIMIT.REMOVE": "Usuń limit",
    "DRIVE.SHARE.LIMIT.INVALID": "Limit miejsca musi być liczbą dodatnią",
    "DRIVE.SHARE.LIMIT.SAVED": "Zaktualizowano limit miejsca",
    "DRIVE.SHARE.LIMIT.ERROR": "Błąd podczas ustawiania limitu miejsca",
    "DRIVE.SHARED.SPACE.FREE": "$SPACE wolnego miejsca w tym udostępnionym folderze",
    "DRIVE.UPLOAD.SHARED.SPACE.ERROR": "Ten udostępniony folder ma tylko $SPACE wolnego miejsca",
    "DRIVE.UPLOAD.SHARED.FULL": "Ten udostępniony folder jest pełny. Usuń niektóre pliki lub poproś właściciela o więcej miejsca.",
    ...
    "DRIVE.PATH.EXPAND": "Pokaż pełną ścieżkę",
    "DRIVE.LINK.CAN.EDIT": "Edycja",
    "DRIVE.LINK.WRITABLE.WARN": "Każdy, kto ma link, może dodawać pliki do elementów oznaczonych jako edytowalne, a zajmą one Twoje miejsce.",
    "DRIVE.LINK.OPTIONS": "Opcje",
    "DRIVE.LINK.DATE": "Data",
    "DRIVE.LINK.TIME": "Godzina",
    "DRIVE.LINK.USES": "Liczba użyć",
    "DRIVE.LINK.PASSWORD.FIELD": "Hasło",
    "DRIVE.LINK.SHOW": "Pokaż",
    "DRIVE.LINK.HIDE": "Ukryj",
    "DRIVE.LINK.COPY.BUTTON": "Kopiuj",
    "DRIVE.LINK.COPIED": "Skopiowano link",
    "DRIVE.LINK.CREATED": "Utworzono link",
    "DRIVE.LINK.URL": "Link",
    "DRIVE.LINK.QR": "Kod QR linku",
    "DRIVE.LINK.QR.HINT": "Zeskanuj go, aby otworzyć link na innym urządzeniu.",
    "FILE.PICKER.TITLE": "Wybierz plik",
    "FILE.PICKER.TITLE.ANY": "Wybierz plik lub folder",
    "FILE.PICKER.EDIT": "Otwórz do edycji",
    "FILE.PICKER.CANCEL": "Anuluj",
    "FILE.PICKER.SELECT": "Wybierz",
    "FILE.PICKER.SELECTED": "Wybrano:",
    "FILE.PICKER.NONE": "Nic nie wybrano",
    ...
    "LAUNCHER.NONE": "Nie zainstalowano jeszcze żadnych aplikacji",
    "LAUNCHER.NONE.BODY": "Utwórz aplikację zielonym plusem w Dysku, wybierając 'Nowa aplikacja'. Zainstalowane aplikacje pojawią się tutaj, gotowe do uruchomienia.",
    "LAUNCHER.NOSHORTCUT": "Nic jeszcze nie przypięto",
    "LAUNCHER.SHORTCUTS":"Skróty",
    "LAUNCHER.ADD.SHORTCUT":"Otwórz menu pliku w Dysku i wybierz 'Dodaj do aplikacji', aby zachować go tutaj.",
    ...
    "ADMIN.DENIED":"Odrzucono prośbę o miejsce od $USER",
    "ADMIN.INVITES":"Zaproszenia do rejestracji",
    "ADMIN.INVITES.UNUSED":"niewykorzystane: $COUNT",
    "ADMIN.INVITES.HINT":"Każdy link pozwala zarejestrować się jednemu nowemu użytkownikowi, nawet gdy ten serwer nie przyjmuje rejestracji.",
    "ADMIN.INVITES.HINT.LISTED":"Pozostaje tutaj, dopóki ktoś go nie użyje lub go nie anulujesz.",
    "ADMIN.INVITES.NO.LIST":"Ten serwer nie może wyświetlić niewykorzystanych zaproszeń, więc skopiuj każdy link teraz: po zamknięciu tego panelu nie zostanie pokazany ponownie.",
    "ADMIN.INVITES.COUNT":"Liczba zaproszeń",
    "ADMIN.INVITES.FEWER":"O jedno zaproszenie mniej",
    "ADMIN.INVITES.MORE":"O jedno zaproszenie więcej",
    "ADMIN.INVITES.CREATE":"Utwórz zaproszenia",
    "ADMIN.INVITES.CREATE.ONE":"Utwórz 1 zaproszenie",
    "ADMIN.INVITES.CREATE.MANY":"Utwórz zaproszenia: $COUNT",
    "ADMIN.INVITES.RANGE":"Wybierz od 1 do $MAX zaproszeń",
    "ADMIN.INVITES.NONE":"Brak niewykorzystanych zaproszeń.",
    "ADMIN.INVITES.CREATE.ERROR":"Nie udało się utworzyć zaproszeń: $REASON",
    "ADMIN.INVITES.LINK":"Link zaproszenia",
    "ADMIN.INVITES.COPY":"Kopiuj",
    "ADMIN.INVITES.COPY.LINK":"Kopiuj link zaproszenia",
    "ADMIN.INVITES.COPIED":"Skopiowano",
    "ADMIN.INVITES.COPY.ERROR":"Nie udało się skopiować do schowka",
