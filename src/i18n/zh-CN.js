module.exports = {
    ...
    "TOUR.TASKS":"任务板",
    "TOUR.TASKS.DESC":"使用我们的任务板来组织和计划事情。",
    "TOUR.CAL":"日历",
    ...
    "DRIVE.UPLOAD.EXISTS":"文件: $NAME a已存在于此位置。您想要更换它吗?",
    ...
    "HELP.FRIENDS.TEXT1":"通过选择左侧菜单上的 3 个连接点图标来显示社交模式。您的社交关系将列在“朋友”、“关注者”和“关注者”下。",
    ...
    "HELP.GRIPES":"抱怨/担忧",
    "HELP.SLOW":"为什么一切都这么慢？",
    "HELP.SLOW.TEXT1":"事实并非如此！整个故事总是更加复杂。在端到端加密和点对点系统中，客户端需要做大量工作（不仅仅是解密/加密）。如果你有技术头脑，可以打开浏览器控制台，观看 100 多个请求的数据流，了解其中的奥妙。",
    ...
    "PROFILE.INVALID":"验证错误",
    "PROFILE.ERROR.WWW":"未设置 Web 目录。更改未保存！",
    ...
    "LAUNCHER.FOLDER":"文件夹",
    "LAUNCHER.REMOVE":"移除",
    "LAUNCHER.EXISTS":"文件: $NAME 已存在于此位置。您想替换它吗？",
    ...
    "NEWSFEED.FILE":"该文件",
    "NEWSFEED.OWNED":"拥有者",
    "TASKS.ERROR.LOAD":"无法加载文件",
    "TASKS.TITLE":"待办事项板",
    "TASKS.CREATE":"创建或打开待办事项板",
    "TASKS.ERROR":"意外的错误",
    "TASKS.ERROR.EXISTS":"具有相同文件名的任务文件已存在！文件尚未保存",
    "TASKS.ERROR.RETRIEVING":"检索文件时出错",
    "TASKS.ERROR.CREATING":"创建文件时出错",
    "TASKS.ERROR.LISTING":"列出目录时出错",
    "TASKS.ERROR.NAV":"导航到目录时出错",
    "TASKS.ERROR.CAS.TITLE":"检测到并发修改",
    "TASKS.ERROR.CAS.TEXT":"该文件已被另一用户更新。您的更改尚未保存。",
    "TASKS.ERROR.UNEXPECTED":"意外的错误",
    "TASKS.ERROR.UPLOAD":"上传文件时出错",
    "TASKS.CLOSE.CONFIRM":"您确定要关闭 $NAME 而不保存吗？",
    "CALENDAR.TITLE":"日历",
    ...
    "CALENDAR.FUTURE.EVENTS":"此事件和未来的事件",
