module.exports = {
    ...
    "DRIVE.RENAME":"重命名",
    "DRIVE.SHARE":"分享",
    "DRIVE.SHARED.PEOPLE":"已与他人共享",
    "DRIVE.SHARED.LINK":"已通过秘密链接共享",
    ...
    "SEARCH.DIR":"目录",
    "SETTINGS.ADMIN":"管理面板",
    "LINK.UNAVAILABLE":"无法打开此链接",
    "LINK.UNAVAILABLE.USED_UP":"此链接的打开次数已达到所有者允许的上限。请向所有者索取新链接。",
    ...
    "DRIVE.SHARE.LIMIT":"空间限制",
    "DRIVE.SHARE.LIMIT.NONE":"无限制",
    "DRIVE.SHARE.LIMIT.SET":"设置限制",
    "DRIVE.SHARE.LIMIT.REMOVE":"移除限制",
    "DRIVE.SHARE.LIMIT.INVALID":"空间限制必须是正数",
    "DRIVE.SHARE.LIMIT.SAVED":"空间限制已更新",
    "DRIVE.SHARE.LIMIT.ERROR":"设置空间限制时出错",
    "DRIVE.SHARED.SPACE.FREE":"此共享文件夹剩余 $SPACE",
    "DRIVE.UPLOAD.SHARED.SPACE.ERROR":"此共享文件夹只剩 $SPACE",
    "DRIVE.UPLOAD.SHARED.FULL":"此共享文件夹已满。请删除一些文件，或请所有者提供更多空间。",
    ...
    "DRIVE.LINK.DATE":"日期",
    "DRIVE.LINK.TIME":"时间",
    "DRIVE.LINK.USES":"使用次数",
    "DRIVE.LINK.PASSWORD.FIELD":"密码",
    "DRIVE.LINK.SHOW":"显示",
    "DRIVE.LINK.HIDE":"隐藏",
    "DRIVE.LINK.COPY.BUTTON":"复制",
    "DRIVE.LINK.COPIED":"链接已复制",
    "DRIVE.LINK.CREATED":"链接已创建",
    "DRIVE.LINK.URL":"链接",
    "DRIVE.LINK.QR":"链接的二维码",
    "DRIVE.LINK.QR.HINT":"扫描即可在其他设备上打开链接。",
    "FILE.PICKER.TITLE":"选择文件",
    "FILE.PICKER.TITLE.ANY":"选择文件或文件夹",
    "FILE.PICKER.EDIT":"以编辑方式打开",
    "FILE.PICKER.CANCEL":"取消",
    "FILE.PICKER.SELECT":"选择",
    "FILE.PICKER.SELECTED":"已选择：",
    "FILE.PICKER.NONE":"未选择任何内容",
    ...
    "CALENDAR.ERROR.SAVE":"无法保存日历",
    "CALENDAR.SHARED.CHANGED":"其他人更改了此条目，因此已重新加载而不是覆盖",
    "CALENDAR.ERROR.SAVE.TASK":"无法保存任务",
    "CALENDAR.ERROR.DELETE.TASK":"无法删除任务",
    "CALENDAR.NAME.EXISTS":"已存在名为 $NAME 的日历",
    ...
    "ADMIN.DENIED":"已拒绝 $USER 的空间申请",
    "ADMIN.INVITES":"注册邀请",
    "ADMIN.INVITES.UNUSED":"$COUNT 个未使用",
    "ADMIN.INVITES.HINT":"每个链接可让一位新用户注册，即使此服务器不接受注册。",
    "ADMIN.INVITES.HINT.LISTED":"在有人使用或您取消之前，它会一直显示在这里。",
    "ADMIN.INVITES.NO.LIST":"此服务器无法列出未使用的邀请，请立即复制每个链接：关闭此面板后将不再显示。",
    "ADMIN.INVITES.COUNT":"邀请数量",
    "ADMIN.INVITES.FEWER":"减少一个邀请",
    "ADMIN.INVITES.MORE":"增加一个邀请",
    "ADMIN.INVITES.CREATE":"创建邀请",
    "ADMIN.INVITES.CREATE.ONE":"创建 1 个邀请",
    "ADMIN.INVITES.CREATE.MANY":"创建 $COUNT 个邀请",
    "ADMIN.INVITES.RANGE":"请选择 1 到 $MAX 个邀请",
    "ADMIN.INVITES.NONE":"没有未使用的邀请。",
    "ADMIN.INVITES.CREATE.ERROR":"无法创建邀请：$REASON",
    "ADMIN.INVITES.LINK":"邀请链接",
    "ADMIN.INVITES.COPY":"复制",
    "ADMIN.INVITES.COPY.LINK":"复制邀请链接",
    "ADMIN.INVITES.COPIED":"已复制",
    "ADMIN.INVITES.COPY.ERROR":"无法复制到剪贴板",
