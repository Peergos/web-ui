module.exports = {
    ...
    "DRIVE.PASTE":"Incolla",
    "DRIVE.WITH":"Con",
    "DRIVE.SELECT":"Seleziona",
    "DRIVE.SELECTED":"selezionato",
    "DRIVE.SORT":"Ordina per",
    "DRIVE.SORT.ASC":"Crescente",
    "DRIVE.SORT.DESC":"Decrescente",
    "DRIVE.NAME":"Nome",
    ...
    "DRIVE.SHARED.PEOPLE":"Condiviso con persone",
    "DRIVE.SHARED.LINK":"Condiviso tramite link segreto",
    ...
    "LINK.UNAVAILABLE":"Impossibile aprire questo link",
    "LINK.UNAVAILABLE.USED_UP":"È già stato aperto tutte le volte consentite dal proprietario. Chiedigli un nuovo link.",
    ...
    "DRIVE.SHARE.LIMIT":"Limite di spazio",
    "DRIVE.SHARE.LIMIT.NONE":"Nessun limite",
    "DRIVE.SHARE.LIMIT.SET":"Imposta limite",
    "DRIVE.SHARE.LIMIT.REMOVE":"Rimuovi limite",
    "DRIVE.SHARE.LIMIT.INVALID":"Il limite di spazio deve essere un numero positivo",
    "DRIVE.SHARE.LIMIT.SAVED":"Limite di spazio aggiornato",
    "DRIVE.SHARE.LIMIT.ERROR":"Errore nell'impostare il limite di spazio",
    "DRIVE.SHARED.SPACE.FREE":"$SPACE liberi in questa cartella condivisa",
    "DRIVE.UPLOAD.SHARED.SPACE.ERROR":"Questa cartella condivisa ha solo $SPACE liberi",
    "DRIVE.UPLOAD.SHARED.FULL":"Questa cartella condivisa è piena. Elimina alcuni file o chiedi più spazio al proprietario.",
    ...
    "DRIVE.PATH.EXPAND":"Mostra il percorso completo",
    "DRIVE.LINK.CAN.EDIT":"Modificabile",
    "DRIVE.LINK.WRITABLE.WARN":"Chiunque abbia il link può aggiungere file a ciò che hai segnato come modificabile, e occuperanno il tuo spazio.",
    "DRIVE.LINK.OPTIONS":"Opzioni",
    "DRIVE.LINK.DATE":"Data",
    "DRIVE.LINK.TIME":"Ora",
    "DRIVE.LINK.USES":"Utilizzi",
    "DRIVE.LINK.PASSWORD.FIELD":"Password",
    "DRIVE.LINK.SHOW":"Mostra",
    "DRIVE.LINK.HIDE":"Nascondi",
    "DRIVE.LINK.COPY.BUTTON":"Copia",
    "DRIVE.LINK.COPIED":"Link copiato",
    "DRIVE.LINK.CREATED":"Link creato",
    "DRIVE.LINK.URL":"Link",
    "DRIVE.LINK.QR":"Codice QR del link",
    "DRIVE.LINK.QR.HINT":"Scansionalo per aprire il link su un altro dispositivo.",
    "FILE.PICKER.TITLE":"Scegli un file",
    "FILE.PICKER.TITLE.ANY":"Scegli un file o una cartella",
    "FILE.PICKER.EDIT":"Apri in modifica",
    "FILE.PICKER.CANCEL":"Annulla",
    "FILE.PICKER.SELECT":"Seleziona",
    "FILE.PICKER.SELECTED":"Selezionato:",
    "FILE.PICKER.NONE":"Nessuna selezione",
    ...
    "CALENDAR.ERROR.SAVE":"Impossibile salvare il calendario",
    "CALENDAR.SHARED.CHANGED":"Qualcun altro ha modificato questa voce, quindi è stata ricaricata anziché sovrascritta",
    "CALENDAR.ERROR.SAVE.TASK":"Impossibile salvare l'attività",
    "CALENDAR.ERROR.DELETE.TASK":"Impossibile eliminare l'attività",
    "CALENDAR.NAME.EXISTS":"Esiste già un calendario chiamato $NAME",
    ...
    "ADMIN.DENIED":"Richiesta di spazio di $USER rifiutata",
    "ADMIN.INVITES":"Inviti alla registrazione",
    "ADMIN.INVITES.UNUSED":"non usati: $COUNT",
    "ADMIN.INVITES.HINT":"Ogni link consente a un nuovo utente di registrarsi, anche quando questo server non accetta registrazioni.",
    "ADMIN.INVITES.HINT.LISTED":"Resta qui finché qualcuno non lo usa o non lo annulli.",
    "ADMIN.INVITES.NO.LIST":"Questo server non può elencare gli inviti non usati, quindi copia ogni link adesso: non verrà mostrato di nuovo dopo aver chiuso questo pannello.",
    "ADMIN.INVITES.COUNT":"Numero di inviti",
    "ADMIN.INVITES.FEWER":"Un invito in meno",
    "ADMIN.INVITES.MORE":"Un invito in più",
    "ADMIN.INVITES.CREATE":"Crea inviti",
    "ADMIN.INVITES.CREATE.ONE":"Crea 1 invito",
    "ADMIN.INVITES.CREATE.MANY":"Crea $COUNT inviti",
    "ADMIN.INVITES.RANGE":"Scegli tra 1 e $MAX inviti",
    "ADMIN.INVITES.NONE":"Nessun invito non usato.",
    "ADMIN.INVITES.CREATE.ERROR":"Impossibile creare gli inviti: $REASON",
    "ADMIN.INVITES.LINK":"Link di invito",
    "ADMIN.INVITES.COPY":"Copia",
    "ADMIN.INVITES.COPY.LINK":"Copia il link di invito",
    "ADMIN.INVITES.COPIED":"Copiato",
    "ADMIN.INVITES.COPY.ERROR":"Impossibile copiare negli appunti",
