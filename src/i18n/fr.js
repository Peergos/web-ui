module.exports = {
    ...
    "DRIVE.SORT": "Trier par",
    "DRIVE.SORT.ASC": "Croissant",
    "DRIVE.SORT.DESC": "Décroissant",
    "DRIVE.NAME": "Nom",
    "DRIVE.SIZE": "Taille",
    "DRIVE.TYPE": "Type",
    ...
    "DRIVE.SHARED.PEOPLE": "Partagé avec des personnes",
    "DRIVE.SHARED.LINK": "Partagé par lien secret",
    ...
    "LINK.UNAVAILABLE":"Impossible d'ouvrir ce lien",
    "LINK.UNAVAILABLE.USED_UP":"Il a déjà été ouvert autant de fois que son propriétaire l'a permis. Demandez-lui un nouveau lien.",
    ...
    "DRIVE.SHARE.LIMIT": "Limite d'espace",
    "DRIVE.SHARE.LIMIT.NONE": "Aucune limite",
    "DRIVE.SHARE.LIMIT.SET": "Définir la limite",
    "DRIVE.SHARE.LIMIT.REMOVE": "Supprimer la limite",
    "DRIVE.SHARE.LIMIT.INVALID": "La limite d'espace doit être un nombre positif",
    "DRIVE.SHARE.LIMIT.SAVED": "Limite d'espace mise à jour",
    "DRIVE.SHARE.LIMIT.ERROR": "Erreur lors de la définition de la limite d'espace",
    "DRIVE.SHARED.SPACE.FREE": "$SPACE libres dans ce dossier partagé",
    "DRIVE.UPLOAD.SHARED.SPACE.ERROR": "Ce dossier partagé n'a que $SPACE libres",
    "DRIVE.UPLOAD.SHARED.FULL": "Ce dossier partagé est plein. Supprimez des fichiers ou demandez plus d'espace à son propriétaire.",
    ...
    "DRIVE.LINK.TIME": "Heure",
    "DRIVE.LINK.USES": "Utilisations",
    "DRIVE.LINK.PASSWORD.FIELD": "Mot de passe",
    "DRIVE.LINK.SHOW": "Afficher",
    "DRIVE.LINK.HIDE": "Masquer",
    "DRIVE.LINK.COPY.BUTTON": "Copier",
    "DRIVE.LINK.COPIED": "Lien copié",
    "DRIVE.LINK.CREATED": "Lien créé",
    "DRIVE.LINK.URL": "Lien",
    "DRIVE.LINK.QR": "Code QR du lien",
    "DRIVE.LINK.QR.HINT": "Scannez-le pour ouvrir le lien sur un autre appareil.",
    "FILE.PICKER.TITLE": "Choisir un fichier",
    "FILE.PICKER.TITLE.ANY": "Choisir un fichier ou un dossier",
    "FILE.PICKER.EDIT": "Ouvrir en modification",
    "FILE.PICKER.CANCEL": "Annuler",
    "FILE.PICKER.SELECT": "Sélectionner",
    "FILE.PICKER.SELECTED": "Sélection :",
    "FILE.PICKER.NONE": "Aucune sélection",
    ...
    "CALENDAR.ERROR.SAVE":"Impossible d'enregistrer le calendrier",
    "CALENDAR.SHARED.CHANGED":"Quelqu'un d'autre a modifié cette entrée, elle a donc été rechargée au lieu d'être écrasée",
    "CALENDAR.ERROR.SAVE.TASK":"Impossible d'enregistrer la tâche",
    "CALENDAR.ERROR.DELETE.TASK":"Impossible de supprimer la tâche",
    "CALENDAR.NAME.EXISTS":"Un calendrier nommé $NAME existe déjà",
    ...
    "ADMIN.DENIED":"Demande d'espace de $USER refusée",
    "ADMIN.INVITES":"Invitations à l'inscription",
    "ADMIN.INVITES.UNUSED":"inutilisées : $COUNT",
    "ADMIN.INVITES.HINT":"Chaque lien permet à un nouvel utilisateur de s'inscrire, même lorsque ce serveur n'accepte pas les inscriptions.",
    "ADMIN.INVITES.HINT.LISTED":"Il reste ici jusqu'à ce que quelqu'un l'utilise ou que vous l'annuliez.",
    "ADMIN.INVITES.NO.LIST":"Ce serveur ne peut pas lister les invitations inutilisées : copiez donc chaque lien maintenant, il ne sera plus affiché après la fermeture de ce panneau.",
    "ADMIN.INVITES.COUNT":"Nombre d'invitations",
    "ADMIN.INVITES.FEWER":"Une invitation de moins",
    "ADMIN.INVITES.MORE":"Une invitation de plus",
    "ADMIN.INVITES.CREATE":"Créer des invitations",
    "ADMIN.INVITES.CREATE.ONE":"Créer 1 invitation",
    "ADMIN.INVITES.CREATE.MANY":"Créer $COUNT invitations",
    "ADMIN.INVITES.RANGE":"Choisissez entre 1 et $MAX invitations",
    "ADMIN.INVITES.NONE":"Aucune invitation inutilisée.",
    "ADMIN.INVITES.CREATE.ERROR":"Impossible de créer les invitations : $REASON",
    "ADMIN.INVITES.LINK":"Lien d'invitation",
    "ADMIN.INVITES.COPY":"Copier",
    "ADMIN.INVITES.COPY.LINK":"Copier le lien d'invitation",
    "ADMIN.INVITES.COPIED":"Copié",
    "ADMIN.INVITES.COPY.ERROR":"Impossible de copier dans le presse-papiers",
