module.exports = {
    ...
    "MOUNT.STATE.NOTMOUNTED":"Not mounted",
    ...
    "MOUNT.TWOFA.HEADING":"This adds a 2FA method to your account",
    "MOUNT.TWOFA.BODY":"A mounted drive signs in on its own, so it needs a code generator of its own. Removing the mount removes that method again.",
    ...
    "MOUNT.PROVISIONING_TOTP":"Setting up a dedicated 2FA method for this mount...",
    "MOUNT.DISABLING":"Removing mount...",
    "MOUNT.TOTP.TITLE":"Set up a dedicated 2FA method for this mount",
    "MOUNT.TOTP.EXPLAIN":"You already have 2FA enabled on your account. To let this drive mount sign in without prompting you for a code every time, we'll add a new TOTP method to your account, used only by this mount.",
    "MOUNT.TOTP.NAME_LABEL":"Method name",
    "MOUNT.TOTP.CLEANUP":"Removing the mount later will also remove this 2FA method from your account.",
    "MOUNT.TOTP.CONFIRM":"Continue and add 2FA method",
