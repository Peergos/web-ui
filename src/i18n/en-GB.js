module.exports = {
    ...
    "ADMIN.INVITES.HINT":"Each link lets one new user sign up, even while this server is not accepting signups. It stays here until someone uses it or you cancel it.",
    ...
    "ADMIN.INVITES.LOAD.ERROR":"Couldn't load the unused invites: $REASON",
