module.exports = {
    ...
    "DRIVE.LINKS.TITLE":"Secret links",
    "DRIVE.LINKS.NONE":"You have no secret links yet.",
    "DRIVE.LINKS.CONTAINS":"Contains",
    "DRIVE.LINKS.ACCESS":"Access",
    "DRIVE.LINKS.PASSWORD":"Password",
    "DRIVE.LINKS.MAXCOUNT":"Max uses",
    "DRIVE.LINKS.EXPIRY":"Expires",
    "DRIVE.LINKS.ITEM":"item",
    "DRIVE.LINKS.ITEMS":"items",
    "DRIVE.LINKS.WRITABLE":"Writable",
    "DRIVE.LINKS.READONLY":"Read-only",
    "DRIVE.LINKS.DELETE":"Delete",
    "DRIVE.LINKS.COPIED":"Link copied",
    "DRIVE.LINKS.DELETE.CONFIRM":"Delete this link?\n\nIt will stop working for everyone, and all %n items in it become unreachable through it:\n%s\n\nAnyone who already opened it keeps access to what they opened.",
    "DRIVE.LINKS.ERROR.LOAD":"Couldn't load your secret links",
    "DRIVE.LINKS.ERROR.DELETE":"Couldn't delete that link",
