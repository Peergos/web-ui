module.exports = {
    ...
    "LOGIN.SERVER.ACTIVE":"Current session",
    "LOGIN.SERVER.USE_CUSTOM":"Use self-hosted/local server",
    "LOGIN.SERVER.SAVE":"Save server",
    "LOGIN.SERVER.RESET":"Use default service",
    "LOGIN.SERVER.RESTART":"Restart the app after saving to reconnect to the new server.",
    "LOGIN.SERVER.ERROR":"Unable to update Peergos server.",
    "LOGIN.SERVER.NETWORK":"Unable to connect to the configured server.",
    "LOGIN.SERVER.CERTIFICATE":"The HTTPS certificate for this server is not trusted by the desktop app. Use a valid trusted certificate or install your internal CA in the system/Java trust store.",
    "LOGIN.SERVER.CONFIGURE_FIRST":"Configure your Peergos server URL above, save, and restart the app.",
    ...
    "DRIVE.ARCHIVE.PASTE.SELF":"A folder can't be pasted into itself",
    ...
    "DRIVE.ARCHIVE.RENAME.ERROR":"Couldn't rename in the zip archive",
    ...
    "LINK.UNAVAILABLE":"This link can't be opened",
    "LINK.UNAVAILABLE.USED_UP":"It has already been opened as many times as its owner allowed. Ask them for a new link.",
    ...
    "SETTINGS.SERVER":"Set Peergos Server",
    "SETTINGS.SERVER.PROMPT":"Peergos server URL (leave blank to restore the default service)",
    "SETTINGS.SERVER.PLACEHOLDER":"https://your-peergos-server",
    "SETTINGS.SERVER.UPDATED":"Peergos server updated. Restart the app to reconnect.",
    ...
    "MFA.BACKUP.GENERATE":"Generate",
    "MFA.BACKUP.REGENERATE":"Regenerate",
    "MFA.BACKUP.DONE":"Done",
    "MFA.BACKUP.COPY":"Copy",
    "MFA.BACKUP.COPIED":"Backup codes copied",
    "MFA.BACKUP.DOWNLOAD":"Download",
    "MFA.BACKUP.TITLE":"Your Backup Codes",
    "MFA.BACKUP.BLURB":"Keep these somewhere safe. Each code can be used once to log in if you lose your authenticator app or security key. They will not be shown again.",
    "MFA.BACKUP.ERROR":"Unable to generate backup codes",
    "MFA.BACKUP.REQUIRES.FACTOR":"Add an Authenticator App or Security Key before generating backup codes",
    "MFA.CONFIRM.REGENERATE.BACKUP":"This will invalidate your existing backup codes. Are you sure?",
    "MFA.CONFIRM.REMOVE.BACKUP":"Are you sure you want to remove your backup codes?",
    "HELP.TITLE":"Help/FAQ",
    "HELP.HOW":"How do I...",
    ...
    "PAID.CANCEL.FOLLOWUP":"Allow us to follow up by email to discuss problems",
    "PAID.CANCEL.WHY":"Why are you cancelling?",
    "DELETE.ACCOUNT.WHY":"Why are you leaving?",
    "FEEDBACK.BETTER":"What can we do better?",
    ...
    "PAID.SORRY":"Sorry to see you go. You can continue using Peergos until the end of your subscription period, and then you will have one month to download your data, after which it will be deleted.",
    ...
    "GROUPS.EMPTY":"empty",
    "GROUPS.TITLE":"Groups",
    "GROUPS.BUILTIN":"Make your own groups of followers to share with. Friends and followers are built-in groups whose members are kept up to date automatically, so they aren't listed here. Other people never see your group names.",
    "GROUPS.NAME":"Group name",
    "GROUPS.MEMBERS.PICK":"Add followers",
    "GROUPS.CREATE":"Create group",
    "GROUPS.CREATED":"Created group $NAME",
    "GROUPS.DUPLICATE":"You already have a group called $NAME",
    "GROUPS.ADD":"Add",
    "GROUPS.RENAME":"Rename",
    "GROUPS.RENAME.TITLE":"Rename $NAME",
    "GROUPS.RENAMED":"Group renamed",
    "GROUPS.DELETE":"Delete",
    "GROUPS.DELETE.TITLE":"Delete $NAME?",
    "GROUPS.DELETE.BODY":"$COUNT item(s) are shared with this group. Deleting the group alone keeps its members' access to those, but nothing new reaches them through it. Revoking re-keys every one of them, which can take a long time.",
    "GROUPS.DELETE.KEEP":"Delete the group",
    "GROUPS.DELETE.REVOKE":"Delete and revoke access to all $COUNT item(s)",
    "GROUPS.DELETE.PROGRESS":"Revoked $DONE of $COUNT",
    "GROUPS.DELETED":"Deleted group $NAME",
    "GROUPS.REMOVE":"Remove from group",
    "GROUPS.REMOVE.TITLE":"Remove $USER from $NAME?",
    "GROUPS.REMOVE.BODY":"$USER will not see anything shared with this group from now on. Things shared with it before that they have already opened are not taken back unless you also revoke them, which re-keys everything ever shared with the group.",
    "GROUPS.REMOVE.KEEP":"Remove from future shares",
    "GROUPS.REMOVE.REVOKE":"Remove and revoke everything shared with the group",
    "GROUPS.REMOVED":"Removed $USER",
    ...
    "DRIVE.LINK.DATE":"Date",
    "DRIVE.LINK.TIME":"Time",
    "DRIVE.LINK.USES":"Uses",
    "DRIVE.LINK.PASSWORD.FIELD":"Password",
    "DRIVE.LINK.SHOW":"Show",
    "DRIVE.LINK.HIDE":"Hide",
    "DRIVE.LINK.COPY.BUTTON":"Copy",
    "DRIVE.LINK.COPIED":"Link copied",
    "DRIVE.LINK.CREATED":"Link created",
    "DRIVE.LINK.URL":"Link",
    "DRIVE.LINK.QR":"QR code for the link",
    "DRIVE.LINK.QR.HINT":"Scan it to open the link on another device.",
    "FILE.PICKER.TITLE":"Choose a file",
    "FILE.PICKER.TITLE.ANY":"Choose a file or folder",
    "FILE.PICKER.EDIT":"Open for editing",
    "FILE.PICKER.CANCEL":"Cancel",
    "FILE.PICKER.SELECT":"Select",
    "FILE.PICKER.SELECTED":"Selected:",
    "FILE.PICKER.NONE":"Nothing selected",
    "DRIVE.SHARE.LINK.ADD.TO.EXISTING":"Add to an existing link",
    "DRIVE.SHARE.LINK.ADD.WARNING":"The link does not change, so anyone already holding it will see this item too.",
    "DRIVE.SHARE.LINK.ADD.READONLY":"Add read-only",
    "DRIVE.SHARE.LINK.ADD.WRITABLE":"Add writable",
    "DRIVE.SHARE.LINK.ADDED":"Added to the link",
    "DRIVE.SHARE.LINK.ITEM":"item",
    "DRIVE.SHARE.LINK.ITEMS":"items",
    "DRIVE.SHARE.LIMIT":"Space limit",
    "DRIVE.SHARE.LIMIT.NONE":"No limit",
    "DRIVE.SHARE.LIMIT.SET":"Set limit",
    "DRIVE.SHARE.LIMIT.REMOVE":"Remove limit",
    "DRIVE.SHARE.LIMIT.INVALID":"The space limit must be a positive number",
    "DRIVE.SHARE.LIMIT.SAVED":"Space limit updated",
    "DRIVE.SHARE.LIMIT.ERROR":"Error setting space limit",
    "DRIVE.SHARED.SPACE.FREE":"$SPACE free in this shared folder",
    "DRIVE.UPLOAD.SHARED.SPACE.ERROR":"This shared folder only has $SPACE free",
    "DRIVE.UPLOAD.SHARED.FULL":"This shared folder is full. Delete some files, or ask its owner for more space.",
    ...
    "DRIVE.LINK.MEMBER.DUPLICATE":"That is already in this link",
    "DRIVE.LINK.MEMBER.TOO.MANY":"A link can hold at most 100 items. Share a folder instead.",
    "DRIVE.LINK.MEMBER.REMOVE.CONFIRM":"Remove %s from this link?\n\nAnyone who opens the link from now on will not see it. Anyone who already opened the link keeps access to it - to take that away you need to revoke access, which changes the file's keys and affects everyone else it is shared with.",
    "DRIVE.LINK.MEMBERS.SAME.URL":"The link and QR code below do not change. Anyone already holding this link will see what you add here.",
    "DRIVE.LINK.MEMBERS.PATHS.VISIBLE":"Whoever opens this link sees each item's full path, including the folders above it.",
    ...
    "LAUNCHER.NONE":"No apps installed yet",
    "LAUNCHER.NONE.BODY":"Make one from the green plus in your Drive, under 'New App'. Installed apps appear here, ready to launch.",
    "LAUNCHER.NOSHORTCUT":"Nothing pinned yet",
    "LAUNCHER.SHORTCUTS":"Shortcuts",
    "LAUNCHER.ADD.SHORTCUT":"Open a file's menu in your Drive and choose 'Add to Launcher' to keep it here.",
    ...
    "SHAREDWITH.EMPTY.TITLE":"Nothing is shared yet",
    "SHAREDWITH.EMPTY.BODY":"Share a file or a folder from your Drive and it appears here, with who you shared it with and what they can do.",
    "NEW.TEMPLATE.APP.NAME.LABEL":"App Title",
    "NEW.TEMPLATE.APP.NAME.MESSAGE":"Title for App:",
    "SYNC.TITLE":"Sync",
    "DIALOG.CLOSE":"Close",
    "FOLDER.PICKER.CANCEL":"Cancel",
    "FOLDER.PICKER.NEW":"New folder",
    "FOLDER.PICKER.NEW.ACTION":"Create",
    "FOLDER.PICKER.NEW.IN":"New folder in \u201c{n}\u201d",
    "FOLDER.PICKER.NEW.PLACEHOLDER":"Folder name",
    "FOLDER.PICKER.SELECT":"Select",
    "FOLDER.PICKER.SELECTED":"Selected path:",
    "FOLDER.PICKER.TITLE":"Choose a folder",
    "SYNC.LOCAL.PICK":"Choose a folder on this device",
    "SYNC.REMOTE.PICK":"Choose a folder in your Drive",
    "SYNC.ADDPAIR":"Add folder",
    "SYNC.STOPPAIR":"Stop syncing",
    "SYNC.NOW":"Sync now",
    "SYNC.NOW.BUSY":"A sync is already running",
    "SYNC.PAUSE":"Pause",
    "SYNC.RESUME":"Resume",
    "SYNC.PAUSED":"Sync paused. It will not run again until you press Resume.",
    ...
    "SYNC.DISABLED.TITLE":"Sync is available in the Desktop and Mobile apps",
    "SYNC.DISABLED":"Download the apps here: ",
    "SYNC.DISABLED2":"The downloaded app should open http://localhost:7777 in a browser, or you can go there directly. Log in and go to the sync page to setup your first sync.",
    "SYNC.FOLDERS":"Synced folders",
    ...
    "SYNC.STATE.ERROR":"Needs attention",
    "SYNC.SUMMARY.PAUSED.TITLE":"Syncing is paused",
    "SYNC.SUMMARY.OK":"Everything is up to date",
    "SYNC.SUMMARY.SYNCING":"Syncing {n} of {m} folders",
    "SYNC.SUMMARY.SYNCING.ONE":"Syncing 1 folder",
    "SYNC.SUMMARY.ERROR.GLOBAL":"Sync reported a problem",
    "SYNC.SUMMARY.ERROR.ONE":"1 folder needs attention",
    "SYNC.SUMMARY.ERROR.MANY":"{n} folders need attention",
    "SYNC.SUMMARY.NONE":"No folders are being synced",
    "SYNC.EMPTY.TITLE":"Nothing is syncing yet",
    "SYNC.EMPTY.BODY":"Pick a folder on this device and a folder in your Drive. Peergos then keeps the two identical, in both directions.",
    "SYNC.DELETES.LOCAL.ON":"Deleting here also deletes in Drive",
    "SYNC.DELETES.LOCAL.OFF":"Deleting here keeps the Drive copy",
    "SYNC.DELETES.REMOTE.ON":"Deleting in Drive also deletes here",
    "SYNC.DELETES.REMOTE.OFF":"Deleting in Drive keeps the copy here",
    "SYNC.MOBILEDATA":"Allow on mobile data",
    "SYNC.MOBILEDATA.ON":"Mobile data allowed for this folder, from the next sync",
    "SYNC.MOBILEDATA.OFF":"Mobile data not allowed for this folder, from the next sync",
    ...
    "APPNAV.MOUNT":"Mount",
    "MOUNT.TIMEOUT":"The drive did not appear. Check that the app has permission to mount.",
    "MOUNT.UNMOUNT":"Unmount",
    "MOUNT.OFFLINE":"No connection. The folder stays mounted, but its files cannot be opened until the connection returns.",
    "MOUNT.STATE.MOUNTED":"Mounted",
    "MOUNT.SUMMARY.MOUNTED":"Your Drive is mounted as a folder",
    "MOUNT.SUMMARY.NOTMOUNTED":"Mount your Drive as a folder on this device",
    "MOUNT.BODY":"Files stay in Peergos and are fetched as you open them, so the folder costs no disk space until you use it.",
    "MOUNT.TITLE":"Mount as Drive",
    "MOUNT.ACTIVE":"Mounted at",
    "MOUNT.ENABLE":"Enable",
    "MOUNT.ENABLING":"Mounting drive...",
    "MOUNT.DISABLE":"Disable",
    "MOUNT.PEERGOS_USER":"Peergos username",
    "MOUNT.MOUNT_PATH":"Mount path:",
    "MOUNT.PEERGOS_PASSWORD":"Peergos password",
    ...
    "MOUNT.USE.DRIVE":"Mount your Drive as a folder",
    "MOUNT.USE.CALENDAR":"Sync your calendars and tasks",
    "MOUNT.USE.CONTACTS":"Sync your contacts",
    "MOUNT.SUMMARY.DRIVE":"Drive mounted",
    "MOUNT.SUMMARY.CALENDAR":"Calendars and tasks syncing",
    "MOUNT.SUMMARY.CONTACTS":"Contacts syncing",
    "MOUNT.DAV.EXPLAIN":"Add this address to a calendar or contacts app on this device. It only works while Peergos is running.",
    "MOUNT.PLATFORM.CALENDAR":"Your calendars appear in this device's Calendar app, and tasks stay in the Peergos calendar.",
    "MOUNT.PLATFORM.CONTACTS":"Your contacts appear in this device's Contacts app.",
    "MOUNT.PLATFORM.BOTH":"Your calendars and contacts appear in this device's Calendar and Contacts apps, and tasks stay in the Peergos calendar.",
    "MOUNT.PLATFORM.CALENDAR.DRIVE":"Your calendars appear in this device's Calendar app, and tasks stay in the Peergos calendar. Any files downloaded will remain in the local folder after unmount.",
    "MOUNT.PLATFORM.CONTACTS.DRIVE":"Your contacts appear in this device's Contacts app. Any files downloaded will remain in the local folder after unmount.",
    "MOUNT.PLATFORM.BOTH.DRIVE":"Your calendars and contacts appear in this device's Calendar and Contacts apps, and tasks stay in the Peergos calendar. Any files downloaded will remain in the local folder after unmount.",
    "MOUNT.DAV.URL":"Server address",
    "MOUNT.DAV.USERNAME":"Username",
    "MOUNT.DAV.PASSWORD":"Password",
    "MOUNT.DAV.SHOW":"Show",
    "MOUNT.DAV.HIDE":"Hide",
    "MOUNT.DAV.COPY":"Copy",
    "MOUNT.DAV.COPIED":"Copied",
    "MOUNT.DAV.COPY_FAILED":"Could not copy to the clipboard",
    "MOUNT.CHECKING_MFA":"Checking your 2FA settings...",
    "MOUNT.PROVISIONING_TOTP":"Setting up this mount's own credential...",
    "MOUNT.DISABLING":"Removing mount...",
    "MOUNT.TOTP.TITLE":"Give this mount its own credential",
    "MOUNT.TOTP.EXPLAIN":"The drive mount signs in on its own, so it needs a credential of its own. We'll add one to your account, used only by this mount. Your authenticator app and security keys are not affected, and you'll never be asked for a code to reach the drive.",
    "MOUNT.TOTP.NAME_LABEL":"It will appear in your 2FA settings as",
    "MOUNT.TOTP.CLEANUP":"Removing the mount removes this credential again. You can also revoke it at any time from your 2FA settings, on any device.",
    "MOUNT.TOTP.CONFIRM":"Continue",
    "MOUNT.TOTP.ENABLE_FAILED":"Server refused to enable this mount's credential.",
    ...
    "MIGRATE.ACCOUNT":"Migrate account to this server",
    "MIGRATE.ACCOUNT.CANCEL":"Cancel",
    "MIGRATE.ACCOUNT.MFA":"Invalid Multi Factor Authenticator code",
    "MIGRATE.ACCOUNT.DONE":"Account migration completed",
    "MIGRATE.ACCOUNT.ERROR":"Error migrating account!",
    "MIGRATE.ACCOUNT.YES":"Yes, migrate account.",
    ...
    "MIGRATE.MIRROR.LOGIN":"Mirror your login data on this server",
    "MIGRATE.MIRROR.DONE":"Mirroring started",
    "MIGRATE.MIRROR.LOGIN.DONE":"Login data mirrored",
    "MIRROR.TITLE":"Mirror",
    ...
    "ADMIN.DENIED":"Space request from $USER denied",
    "ADMIN.INVITES":"Signup invites",
    "ADMIN.INVITES.UNUSED":"$COUNT unused",
    "ADMIN.INVITES.HINT":"Each link lets one new user sign up, even while this server is not accepting signups.",
    "ADMIN.INVITES.HINT.LISTED":"It stays here until someone uses it or you cancel it.",
    "ADMIN.INVITES.NO.LIST":"This server can't list unused invites, so copy each link now: it isn't shown again after you close this panel.",
    "ADMIN.INVITES.COUNT":"How many invites",
    "ADMIN.INVITES.FEWER":"One fewer invite",
    "ADMIN.INVITES.MORE":"One more invite",
    "ADMIN.INVITES.CREATE":"Create invites",
    "ADMIN.INVITES.CREATE.ONE":"Create 1 invite",
    "ADMIN.INVITES.CREATE.MANY":"Create $COUNT invites",
    "ADMIN.INVITES.RANGE":"Choose between 1 and $MAX invites",
    "ADMIN.INVITES.NONE":"No unused invites.",
    "ADMIN.INVITES.CREATE.ERROR":"Couldn't create invites: $REASON",
    "ADMIN.INVITES.LINK":"Invite link",
    "ADMIN.INVITES.COPY":"Copy",
    "ADMIN.INVITES.COPY.LINK":"Copy invite link",
    "ADMIN.INVITES.COPIED":"Copied",
    "ADMIN.INVITES.COPY.ERROR":"Couldn't copy to the clipboard",
