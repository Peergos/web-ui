...
"SIGNUP.HYPER": "de almacenamiento hiperseguro",
    ...
    "DRIVE.PASTE": "Pegar",
    "DRIVE.WITH": "Con",
    "DRIVE.SELECT":"Seleccionar",
    "DRIVE.SELECTED": "seleccionado",
    "DRIVE.SORT": "Ordenar por",
    "DRIVE.SORT.ASC": "Ascendente",
    "DRIVE.SORT.DESC": "Descendente",
    "DRIVE.NAME": "Nombre",
    "DRIVE.SIZE": "Tamaño",
    "DRIVE.TYPE": "Tipo",
    ...
    "DRIVE.SHARED.PEOPLE": "Compartido con personas",
    "DRIVE.SHARED.LINK": "Compartido mediante enlace secreto",
    ...
    "LINK.UNAVAILABLE":"No se puede abrir este enlace",
    "LINK.UNAVAILABLE.USED_UP":"Ya se ha abierto tantas veces como permitió su propietario. Pídale un enlace nuevo.",
    ...
    "DRIVE.SHARE.LIMIT": "Límite de espacio",
    "DRIVE.SHARE.LIMIT.NONE": "Sin límite",
    "DRIVE.SHARE.LIMIT.SET": "Establecer límite",
    "DRIVE.SHARE.LIMIT.REMOVE": "Quitar límite",
    "DRIVE.SHARE.LIMIT.INVALID": "El límite de espacio debe ser un número positivo",
    "DRIVE.SHARE.LIMIT.SAVED": "Límite de espacio actualizado",
    "DRIVE.SHARE.LIMIT.ERROR": "Error al establecer el límite de espacio",
    "DRIVE.SHARED.SPACE.FREE": "$SPACE libres en esta carpeta compartida",
    "DRIVE.UPLOAD.SHARED.SPACE.ERROR": "Esta carpeta compartida solo tiene $SPACE libres",
    "DRIVE.UPLOAD.SHARED.FULL": "Esta carpeta compartida está llena. Elimina algunos archivos o pide más espacio a su propietario.",
    ...
    "DRIVE.LINK.DATE": "Fecha",
    "DRIVE.LINK.TIME": "Hora",
    "DRIVE.LINK.USES": "Usos",
    "DRIVE.LINK.PASSWORD.FIELD": "Contraseña",
    "DRIVE.LINK.SHOW": "Mostrar",
    "DRIVE.LINK.HIDE": "Ocultar",
    "DRIVE.LINK.COPY.BUTTON": "Copiar",
    "DRIVE.LINK.COPIED": "Enlace copiado",
    "DRIVE.LINK.CREATED": "Enlace creado",
    "DRIVE.LINK.URL": "Enlace",
    "DRIVE.LINK.QR": "Código QR del enlace",
    "DRIVE.LINK.QR.HINT": "Escanéalo para abrir el enlace en otro dispositivo.",
    "FILE.PICKER.TITLE": "Elige un archivo",
    "FILE.PICKER.TITLE.ANY": "Elige un archivo o carpeta",
    "FILE.PICKER.EDIT": "Abrir para editar",
    "FILE.PICKER.CANCEL": "Cancelar",
    "FILE.PICKER.SELECT": "Seleccionar",
    "FILE.PICKER.SELECTED": "Seleccionado:",
    "FILE.PICKER.NONE": "Nada seleccionado",
    ...
    "CALENDAR.ERROR.SAVE":"No se puede guardar el calendario",
    "CALENDAR.SHARED.CHANGED":"Otra persona cambió esta entrada, así que se recargó en lugar de sobrescribirla",
    "CALENDAR.ERROR.SAVE.TASK":"No se puede guardar la tarea",
    "CALENDAR.ERROR.DELETE.TASK":"No se puede eliminar la tarea",
    "CALENDAR.NAME.EXISTS":"Ya existe un calendario llamado $NAME",
    ...
    "ADMIN.DENIED":"Solicitud de espacio de $USER denegada",
    "ADMIN.INVITES":"Invitaciones de registro",
    "ADMIN.INVITES.UNUSED":"$COUNT sin usar",
    "ADMIN.INVITES.HINT":"Cada enlace permite registrarse a un nuevo usuario, incluso si este servidor no acepta registros.",
    "ADMIN.INVITES.HINT.LISTED":"Permanece aquí hasta que alguien lo use o usted lo cancele.",
    "ADMIN.INVITES.NO.LIST":"Este servidor no puede listar las invitaciones sin usar, así que copie cada enlace ahora: no se volverá a mostrar después de cerrar este panel.",
    "ADMIN.INVITES.COUNT":"Número de invitaciones",
    "ADMIN.INVITES.FEWER":"Una invitación menos",
    "ADMIN.INVITES.MORE":"Una invitación más",
    "ADMIN.INVITES.CREATE":"Crear invitaciones",
    "ADMIN.INVITES.CREATE.ONE":"Crear 1 invitación",
    "ADMIN.INVITES.CREATE.MANY":"Crear $COUNT invitaciones",
    "ADMIN.INVITES.RANGE":"Elija entre 1 y $MAX invitaciones",
    "ADMIN.INVITES.NONE":"Ninguna invitación sin usar.",
    "ADMIN.INVITES.CREATE.ERROR":"No se pudieron crear las invitaciones: $REASON",
    "ADMIN.INVITES.LINK":"Enlace de invitación",
    "ADMIN.INVITES.COPY":"Copiar",
    "ADMIN.INVITES.COPY.LINK":"Copiar enlace de invitación",
    "ADMIN.INVITES.COPIED":"Copiado",
    "ADMIN.INVITES.COPY.ERROR":"No se pudo copiar al portapapeles",
