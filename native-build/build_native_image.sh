...
# ./peergos -peergos -admin-usernames demo -logToConsole true
...
#$NATIVE_IMAGE_JAVA -agentlib:native-image-agent=config-output-dir=META-INF/native-image -jar Peergos.jar -peergos -default-quota 209715200 -useIPFS true -peergos.identity.hash z59vuwzfFDp3ZA8ZpnnmHEuMtyA1q34m3Th49DYXQVJntWpxdGrRqXi -pki-node-id QmVdFZgHnEgcedCS2G2ZNiEN59LuVrnRm7z3yXtEBv2XiF -max-users 2
