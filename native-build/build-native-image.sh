...
$NATIVE_IMAGE_BIN --allow-incomplete-classpath -H:EnableURLProtocols=http -H:IncludeResources='./webroot/.*' -H:+ReportUnsupportedElementsAtRuntime -H:ConfigurationFileDirectories=META-INF/native-image --no-fallback --initialize-at-build-time=org.slf4j.LoggerFactory,org.sqlite.DB,org.sqlite.NativeDB,org.sqlite.Function,org.sqlite.Function\$Aggregate,org.sqlite.DB\$ProgressObserver -jar "$PEERGOS_JAR_PATH" peergos
