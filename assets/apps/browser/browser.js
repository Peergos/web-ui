...
let handler = function (e) {
      ...
      let appIFrame = document.getElementById("appId");
      if (appIFrame != null) {
...
function load(appFilePath) {
    let that = this;
    removeServiceWorkerRegistration(() => {
        let fileStream = streamSaver.createWriteStream("browser", "text/html", url => {
                let iframe = document.getElementById("appId");
                iframe.src= appFilePath;
